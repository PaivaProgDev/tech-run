...
const Input = ({ titleName, type, onChange, value, pattern, required, inputBox, eyeIcon, className, iconName, placeholder, minLength, maxLength, disabled }) => {
    ...
    return (
        <div className="flex flex-col gap-1.5">
            ...
            <div className={`${theme === 'dark' && 'bg-zinc-700 border-0'} w-full flex items-center gap-3 border border-gray-200 bg-[var(--color-bg)] focus-within:border-[var(--color-1)] rounded-lg px-2.5 py-1.5`}>
                {iconName}
