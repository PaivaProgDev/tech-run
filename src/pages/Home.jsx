            ...
            <section className="flex flex-col min-h-screen justify-center items-center gap-4 py-6 px-5 bg-[var(--color-bg)]">
                ...
                <div className="flex flex-col gap-5">
                    <div className="flex gap-4 bg-white p-4 rounded-xl">
                        ...
                        <div>
                            <h4 className="font-medium w-full text-[15.5px]">Interface intuitiva</h4>
                    ...
                    <div className="flex gap-4 bg-white p-4 rounded-xl">
                        ...
                        <div>
                            <h4 className="font-medium w-full text-[15.5px]">Dados em tempo real</h4>
                    ...
                    <div className="flex gap-4 bg-white p-4 rounded-xl">
                        ...
                        <div>
                            <h4 className="font-medium w-full text-[15.5px]">Relatórios Detalhados</h4>
                    ...
                    <div className="flex gap-4 bg-white p-4 rounded-xl">
                        ...
                        <div>
                            <h4 className="font-medium w-full text-[15.5px]">Gestão Simplificada</h4>
